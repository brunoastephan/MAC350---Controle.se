...
object DatabaseContract {
    ...
    val SQL_CREATE_ENTRIES_ARRAY = listOf(SQL_CREATE_TRANSACTIONS_ENTRIES, SQL_CREATE_CATEGORIES_ENTRIES, SQL_CREATE_GOALS_ENTRIES)
    val SQL_DELETE_ENTRIES_ARRAY = listOf(SQL_DELETE_TRANSACTIONS_ENTRIES, SQL_DELETE_CATEGORIES_ENTRIES, SQL_DELETE_GOALS_ENTRIES)
